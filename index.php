...
<div class="container">
    ...
    <div class="well text-center">
        ...
        <h1>Welcome To QuickBooks Application</h1>
    ...
    <p>Login Here To Access QuickBox API's</p>
    <pre id="accessToken">
        <style="background-color:#efefef;overflow-x:scroll"><?php
    $displayString = isset($accessTokenJson) ? $accessTokenJson['access_token'] : "No Access Token Generated Yet";
